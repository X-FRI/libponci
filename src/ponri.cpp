...
void
resgroup_create(const char * name)
{
...
void
resgroup_delete(const char * name)
{
  const auto rgp = resgroup_path(name);
...
void
resgroup_add_me(const char * name)
{
...
void
resgroup_add_task(const char * name, const pid_t tid)
{
...
void
resgroup_set_cpus(const char * name, const size_t * cpus, size_t size)
{
  assert(size < 64);
...
void
resgroup_set_cpus(const std::string & name, const std::vector<size_t> & cpus)
{
...
// TODO support L2
void
resgroup_set_schemata(const char * name, const size_t * schematas, size_t size)
{
  /*
...
void
resgroup_set_schemata(const std::string & name, const std::vector<size_t> & schematas)
{
...
std::bitset<64>
increase_bitset(std::bitset<64> bits)
{
